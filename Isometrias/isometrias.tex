...
\]
y sea $A \in \mathcal{O}(3)$ es una matriz ortogonal. Entonces
\begin{align*}
Ax : &I \to \mathbb{R}^3- \{0\}\\
&t \mapsto Ax(t)
\end{align*}
...
Ahora, teniendo en cuenta que $f(\lVert x(t) \rVert)$ una constante y la propiedad que define la isometría, $\lVert x \rVert = \lVert f(x) \rVert = \lVert Ax \rVert$ podemos escribir lo que sigue:
